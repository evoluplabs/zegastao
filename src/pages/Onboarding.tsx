    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            {step === 0 && 'Vamos começar com o básico.'}
            {step === 1 && 'Tem alguma dívida? (opcional)'}
            {step === 2 && 'Quais são suas habilidades?'}
            {step === 3 && 'Qual é seu maior sonho financeiro?'}
            {step === 4 && 'Você já investe em algo?'}
          </CardDescription>
        </CardHeader>
